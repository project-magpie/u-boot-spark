...
static void b2000_hwcontrol(struct mtd_info *mtdinfo, int cmd)
{
 ...
 */
#ifndef CFG_NAND_FLEX_MODE	/* for "bit-banging" (c.f. STM "flex-mode")  */
static int b2000_device_ready(struct mtd_info *mtd)
{
...
extern int board_nand_init(struct nand_chip * const nand)
{
	...
	stm_default_board_nand_init(nand, b2000_hwcontrol, b2000_device_ready);
#endif
