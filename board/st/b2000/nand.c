...
static void stxh415_hwcontrol(struct mtd_info *mtdinfo, int cmd)
{
 ...
 */
#ifndef CFG_NAND_FLEX_MODE	/* for "bit-banging" (c.f. STM "flex-mode")  */
static int stxh415_device_ready(struct mtd_info *mtd)
{
...
extern int board_nand_init(struct nand_chip *nand)
{
	...
	nand->dev_ready     = stxh415_device_ready;
	nand->hwcontrol     = stxh415_hwcontrol;
#endif /* CFG_NAND_FLEX_MODE */
