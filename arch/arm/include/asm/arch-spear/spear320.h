...
#define SPEAR320_GPIO_SELECT1		(CONFIG_SPEAR_RASBASE + 0x0028)
#define SPEAR320_GPIO_SELECT2		(CONFIG_SPEAR_RASBASE + 0x002C)
#define SPEAR320_GPIO_SELECT3		(CONFIG_SPEAR_RASBASE + 0x0030)
#define SPEAR320_GPIO_OUT0		(CONFIG_SPEAR_RASBASE + 0x0034)
#define SPEAR320_GPIO_EN0		(CONFIG_SPEAR_RASBASE + 0x0044)
#define SPEAR320_GPIO_EN1		(CONFIG_SPEAR_RASBASE + 0x0048)
#define SPEAR320_GPIO_EN2		(CONFIG_SPEAR_RASBASE + 0x004C)
#define SPEAR320_GPIO_EN3		(CONFIG_SPEAR_RASBASE + 0x0050)
