/*
 * arch/st40/include/asm/processor.h
 *
 * Copyright (C) 1999, 2000  Niibe Yutaka
 */

#ifndef __ARCH_ST40_INCLUDE_ASM_PROCESSOR_H
#define __ARCH_ST40_INCLUDE_ASM_PROCESSOR_H
...
#endif /* __ARCH_ST40_INCLUDE_ASM_PROCESSOR_H */
