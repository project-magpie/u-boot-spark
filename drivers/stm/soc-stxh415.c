...
volatile int debug_pad_configs = 0;
	...
	/*
	 * The ST40 in the STxH415 is only supported in 32-bit (SE) mode,
...
static struct stm_pad_pin stxh415_ethernet_mii_pad_configs[] = {
			...
			CLOCK_OUT(15, 5, 2, RET_NICLK(0, 1)),/* MDC */
...
#if 0
#if CONFIG_SYS_STM_STMAC_BASE == CONFIG_SYS_STM_STMAC0_BASE	/* GMAC #0 */
static struct stm_pad_pin stxh415_ethernet_gmii_pad_configs[] = {
...
#if CONFIG_SYS_STM_STMAC_BASE == CONFIG_SYS_STM_STMAC0_BASE	/* GMAC #0 */
static struct stm_pad_pin stxh415_ethernet_rgmii_pad_configs[] = {
			...
			CLOCK_IN(15, 0, 2, RET_ICLK(0, 0)),/* TXCLK */
...
#if CONFIG_SYS_STM_STMAC_BASE == CONFIG_SYS_STM_STMAC0_BASE	/* GMAC #0 */
static struct stm_pad_pin stxh415_ethernet_rmii_pad_configs[] = {
			PHY_CLOCK(13, 5, 2, RET_NICLK(0, 1)),/* PHYCLK */
			DATA_IN(13, 6, 2, RET_BYPASS(0)),/* MDINT */
			DATA_OUT(13, 7, 2, RET_SE_NICLK_IO(0, 0)),/* TXEN */
			DATA_OUT(14, 0, 2, RET_SE_NICLK_IO(0, 0)),/* TXD[0] */
...
#if 0
#if CONFIG_SYS_STM_STMAC_BASE == CONFIG_SYS_STM_STMAC0_BASE	/* GMAC #0 */
static struct stm_pad_pin stxh415_ethernet_reverse_mii_pad_configs[] = {
			...
			CLOCK_IN(15, 5, 3, RET_NICLK(0, 0)),/* MDC */
...
{
#if CONFIG_SYS_STM_STMAC_BASE == CONFIG_SYS_STM_STMAC0_BASE	/* GMAC #0 */
	stmac_eth_register(0, CONFIG_SYS_STM_STMAC0_BASE);
#endif

#if CONFIG_SYS_STM_STMAC_BASE == CONFIG_SYS_STM_STMAC1_BASE	/* GMAC #1 */
	stmac_eth_register(1, CONFIG_SYS_STM_STMAC1_BASE);
#endif
