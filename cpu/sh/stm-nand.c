...
#define DEBUG_FLEX		0	/* Enable additional debugging of the FLEX controller */  //YWDRIVER_MODI lwj change 1 to 0
#define VERBOSE_ECC		0	/* Enable for verbose ECC information  */ //YWDRIVER_MODI lwj change 1 to 0
