...
#	define CONFIG_SYS_STM_ASC_BASE	CONFIG_SYS_STM_ASC2_BASE	/* UART2 = AS0 */
#else
	/* Lower 9-pin Male connector */
#	define CONFIG_SYS_STM_ASC_BASE	CONFIG_SYS_STM_ASC3_BASE	/* UART3 = AS1 */
#endif
...
#define CONFIG_SYS_PROMPT		"MB704> "		/* Monitor Command Prompt	*/
