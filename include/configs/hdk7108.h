...
#if (CONFIG_SYS_TEXT_BASE == (CONFIG_SYS_SDRAM_BASE + (127<<20)))	/* CONFIG_SYS_TEXT_BASE == SDRAM_BASE + 127 MiB ? */
#	define CONFIG_SYS_SDRAM_SIZE	0x08000000	/* 128 MiB of LMI SDRAM */
#elif (CONFIG_SYS_TEXT_BASE == (CONFIG_SYS_SDRAM_BASE + (255<<20)))	/* CONFIG_SYS_TEXT_BASE == SDRAM_BASE + 255 MiB ? */
#	define CONFIG_SYS_SDRAM_SIZE	0x10000000	/* 256 MiB of LMI SDRAM */
#elif (CONFIG_SYS_TEXT_BASE == (CONFIG_SYS_SDRAM_BASE + (511<<20)))	/* CONFIG_SYS_TEXT_BASE == SDRAM_BASE + 511 MiB ? */
#	define CONFIG_SYS_SDRAM_SIZE	0x20000000	/* 512 MiB of LMI SDRAM */
#else
#	error Unexpected value for CONFIG_SYS_TEXT_BASE.
