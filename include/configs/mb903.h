...
#define CONFIG_SYS_EMI_SPI_BASE		0xA0000000	/* EMI Bank #0: SPI Flash,  Physical 0x00000000 */
#define CONFIG_SYS_EMI_NOR_BASE		0xA4000000	/* CSB: NOR Flash,  Physical 0x04000000 */
#else
#define CONFIG_SYS_EMI_NOR_BASE		0xA0000000	/* CSA: NOR Flash,  Physical 0x00000000 */
...
#	define CONFIG_SYS_STM_STMAC0_BASE	0xfda88000ul	/* MII #0 (MoCA module) */
...
#	define CONFIG_SYS_USB0_BASE			0xfe000000	/* #0 is front port */
#	define CONFIG_SYS_USB1_BASE			0xfe100000	/* #1 is upper-rear */
#	define CONFIG_SYS_USB2_BASE			0xfe200000	/* #2 is lower-rear */
...
#define CONFIG_SYS_PROMPT		"MB903> "		/* Monitor Command Prompt	*/
