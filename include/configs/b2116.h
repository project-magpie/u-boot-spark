 ...
 *
 *	There are 5 jumpers for the boot device (SW1-1 to SW1-5)
 *
 *					MODE	1-5 1-2 1-1 1-4 1-3
 ...
 *
 *
 *	In addition, please select the boot-master core (SW1-7):
 *
 *	Boot-Master	MODE[1]		SW1-7
 *	-----------	-------		-----
 *	Coretex-A9	0		 ON
 *	ST40		1		off
 */
 ...
 */
#define CONFIG_MACH_STM_B2116	4506		/* MACH_TYPE_STM_B2116 */
#define CONFIG_MACH_TYPE	CONFIG_MACH_STM_B2116
 ...
 * Note: this will be implicitly defined if "make b2116<xx>_nand_config" is run.
 */
 ...
 * Note: this will be implicitly defined if "make b2116<xx>_spi_config" is run.
 */
...
#else
#	define CONFIG_SYS_STM_ASC_BASE	STXH416_SBC_ASC0_BASE	/* SBC_UART0 on J29 (off-board) */
#endif
 ...
 * (GMAC #1) is connected. This MAC is connected to a
 * Realtek RTL8211E on-board PHY (UE1).
 */
...
#	define CONFIG_SYS_USB0_BASE			0xfe100000	/* #0 (J16) is next to Fan Power */
#	define CONFIG_SYS_USB1_BASE			0xfe200000	/* #1 (J23) is next to HDMI */
#	define CONFIG_SYS_USB2_BASE			0xfe300000	/* #2 (J17) is on the front */
...
#define CONFIG_SYS_PROMPT		"B2116> "		/* Monitor Command Prompt	*/
