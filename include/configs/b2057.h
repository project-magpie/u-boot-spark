 ...
 *
 *	Note:	In all cases, NAND_CS# (via JF3) should always be tied to CSA#,
...
#else
#	define CONFIG_SYS_STM_ASC_BASE	STXH205_ASC1_BASE	/* JK1, off-board */
#endif
...
#	define CONFIG_SYS_USB1_BASE			0xfe100000	/* USB #1 is front port (JD2) */
...
#define CONFIG_SYS_PROMPT		"B2057> "		/* Monitor Command Prompt	*/
