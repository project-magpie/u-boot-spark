...
#endif /* CFG_BOOT_FROM_SPI || CFG_BOOT_FROM_NAND */
#if defined(CFG_BOOT_FROM_SPI) && defined(CFG_BOOT_FROM_NAND)
#	error Only one of CFG_BOOT_FROM_SPI or CFG_BOOT_FROM_NAND must be defined!
#endif /* CFG_BOOT_FROM_SPI && CFG_BOOT_FROM_NAND */
...
#if 1
#	define CFG_STM_ASC_BASE		STXH415_ASC2_BASE	/* UART2 on CN14 (COM0) */
#elif 1
#	define CFG_STM_ASC_BASE		STXH415_SBC_ASC1_BASE	/* SBC_UART1 on CN28 (COM1) */
#else
#	define CFG_STM_ASC_BASE		STXH415_SBC_ASC0_BASE	/* SBC_UART0 on CN19 */
#endif
 ...
 *
 *	GMAC #0 is wired to CN22, for a daughter-board PHY
...
#undef	CONFIG_SH_STB7100_USB	/* QQQ - TO TEST USB */
...
//#define CONFIG_SH_STM_SATA	/* QQQ - TO TEST SATA */
...
#define CFG_PROMPT		"B2000> "	/* Monitor Command Prompt	*/
...
#	define CFG_EMI_NAND_BASE	0xDEADBEEF	/* for FLEX-mode, we do not care! */
	 ...
	 */
#	define CFG_SH_NAND_USE_HAMMING	/* define to use the Hamming driver */
 ...
 *	U36	ST	N25Q128
 *
 *	To use U36, the following 8 jumpers (4 per connector) should be fitted:
 *		CN35: 1-2, 3-4, 5-6, 7-8.
 *		CN36: 1-2, 3-4, 5-6, 7-8.
 */
#if defined(CONFIG_SPI_FLASH)			/* SPI serial flash present ? */
#	define CONFIG_SPI_FLASH_ST		/* ST N25Q128 (U36) */
...
#if 1 && defined(CFG_BOOT_FROM_NAND) &&		/* booting from NAND ? */ \
...
#		define CFG_I2C_SPEED	400000		/* I2C clock speed (400 kHz) */
#		define I2C_DELAY	do { NDELAY(625); } while (0)	/* 625 ns */
#	else	/* else, run the I2C bus clock at 100 kHz */
#		define CFG_I2C_SPEED	100000		/* I2C clock speed (100 kHz) */
