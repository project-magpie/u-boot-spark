...
#if defined(CONFIG_STM_STXH416)					/* Only the STxH416 has a 4th USB controller */
...
#define CONFIG_SYS_PROMPT		"B2000> "		/* Monitor Command Prompt	*/
 ...
 * as well as the potency CONFIG_SYS_STM_NAND_USE_BCH_xxx_ECC.
 */
