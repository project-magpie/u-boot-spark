 ...
 *
 *	Note:	The default NAND on the B2075 is *not* capable
...
#if 1
#	define CONFIG_SYS_STM_ASC_BASE	STXH205_ASC10_BASE	/* CN32, on-board DB9 */
#else
#	define CONFIG_SYS_STM_ASC_BASE	STXH205_ASC1_BASE	/* JD7, off-board */
#endif
...
#	define CONFIG_SYS_USB1_BASE			0xfe100000	/* USB #1 (JD3) */
...
#define CONFIG_SYS_PROMPT		"B2075> "		/* Monitor Command Prompt	*/
