...
#define CONFIG_MACH_TYPE	CONFIG_MACH_STM_B2120	/* For the time being. */
...
#define CONFIG_SYS_SDRAM_SIZE		0x20000000	/* 512MB of LMI SDRAM */
...
#if 1
#	define CONFIG_SYS_STM_ASC_BASE	STXH301_SBC_ASC0_BASE	/* SBC_UART0 on J12 (off-board) */ //imran cmntd
//bcoz I m testing on b2089
//#	define CONFIG_SYS_STM_ASC_BASE	STXH301_ASC1_BASE	/* SBC_UART0 on J12 (off-board) */ //imran added
//bcoz I m testing on b2089
#else
#	define CONFIG_SYS_STM_ASC_BASE	STXH301_SBC_ASC1_BASE	/* SBC_UART1 on J13 (off-board) */
#endif
...
/*
 * On the STxH301 SoC there is only a single GMAC device (GMAC1) present.
 * On the B2173 board, it is connected to an on-board RealTek RTL8211RB
...
#	define CONFIG_STMAC_RTL8211E		/* Realtek RTL8211 */
...
#define CONFIG_SYS_PROMPT		"B2173> "		/* Monitor Command Prompt	*/
...
#define CONFIG_CMDLINE_EDITING
	 ...
	 */
//#define CONFIG_MACH_STM_STXH301_A9SS_VCORE_HACK
...
#	define SPI_SCL(val)	do { stxh301_spi_scl((val)); } while (0)
#	define SPI_SDA(val)	do { stxh301_spi_sda((val)); } while (0)
#	define SPI_READ		stxh301_spi_read()
...
#	define CONFIG_I2C_BUS		7	/* Use I2C Bus associated with SSC #5 */
...
#	define I2C_SCL(val)		do { stxh301_i2c_scl((val)); } while (0)
#	define I2C_SDA(val)		do { stxh301_i2c_sda((val)); } while (0)
#	define I2C_READ			stxh301_i2c_read()
...
#		define CONFIG_SYS_I2C_SOFT_SPEED	400000			/* I2C clock speed (400 kHz) */
