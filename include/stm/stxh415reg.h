...
#ifndef __INCLUDE_STM_STXH415REG_H
#define __INCLUDE_STM_STXH415REG_H
...
#define STM_EMISS_REGS_BASE			0xfef00000
...
#define STXH415_SYSCFG(x)							\
	(									\
		((x) < 100)							\
		? STM_U32_REG(STXH415_SAS_SBC_SYSCONF_BASE + ((x)-0)*0x4)	\
		:								\
		((x) < 300)							\
		? STM_U32_REG(STXH415_SAS_FRONT_SYSCONF_BASE + ((x)-100)*0x4)	\
		:								\
		((x) < 400)							\
		? STM_U32_REG(STXH415_SAS_REAR_SYSCONF_BASE + ((x)-300)*0x4)	\
		:								\
		((x) < 500)							\
		? STM_U32_REG(STXH415_MPE_LEFT_SYSCONF_BASE + ((x)-400)*0x4)	\
		:								\
		((x) < 600)							\
		? STM_U32_REG(STXH415_MPE_RIGHT_SYSCONF_BASE + ((x)-500)*0x4)	\
		:								\
...
#define STXH415_CKGB_LOCK		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x10)
#define STXH415_CKGB_FS0_CTRL		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x14)
#define STXH415_CKGB_FS0_MD0		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x18)
#define STXH415_CKGB_FS0_PE0		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x1c)
#define STXH415_CKGB_FS0_EN_PRG0	STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x20)
#define STXH415_CKGB_FS0_SDIV0		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x24)
#define STXH415_CKGB_FS0_MD1		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x28)
#define STXH415_CKGB_FS0_PE1		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x2c)
#define STXH415_CKGB_FS0_EN_PRG1	STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x30)
#define STXH415_CKGB_FS0_SDIV1		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x34)
#define STXH415_CKGB_FS0_MD2		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x38)
#define STXH415_CKGB_FS0_PE2		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x3c)
#define STXH415_CKGB_FS0_EN_PRG2	STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x40)
#define STXH415_CKGB_FS0_SDIV2		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x44)
#define STXH415_CKGB_FS0_MD3		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x48)
#define STXH415_CKGB_FS0_PE3		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x4c)
#define STXH415_CKGB_FS0_EN_PRG3	STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x50)
#define STXH415_CKGB_FS0_SDIV3		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x54)
#define STXH415_CKGB_FS0_CLKOUT_CTRL	STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x58)
#define STXH415_CKGB_FS1_CTRL		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x5c)
#define STXH415_CKGB_FS1_MD0		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x60)
#define STXH415_CKGB_FS1_PE0		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x64)
#define STXH415_CKGB_FS1_EN_PRG0	STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x68)
#define STXH415_CKGB_FS1_SDIV0		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x6c)
#define STXH415_CKGB_FS1_MD1		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x70)
#define STXH415_CKGB_FS1_PE1		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x74)
#define STXH415_CKGB_FS1_EN_PRG1	STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x78)
#define STXH415_CKGB_FS1_SDIV1		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x7c)
#define STXH415_CKGB_FS1_MD2		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x80)
#define STXH415_CKGB_FS1_PE2		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x84)
#define STXH415_CKGB_FS1_EN_PRG2	STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x88)
#define STXH415_CKGB_FS1_SDIV2		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x8c)
#define STXH415_CKGB_FS1_MD3		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x90)
#define STXH415_CKGB_FS1_PE3		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x94)
#define STXH415_CKGB_FS1_EN_PRG3	STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x98)
#define STXH415_CKGB_FS1_SDIV3		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0x9c)
#define STXH415_CKGB_FS1_CLKOUT_CTRL	STM_U32_REG(STXH415_CKGB_REGS_BASE + 0xa0)
#define STXH415_CKGB_FS_CFG0		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0xa4)
#define STXH415_CKGB_FS_CFG1		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0xa8)
#define STXH415_CKGB_FS_CFG2		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0xac)
#define STXH415_CKGB_CLOCK_ENABLE	STM_U32_REG(STXH415_CKGB_REGS_BASE + 0xb0)
#define STXH415_CKGB_OUT_CTRL		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0xb4)
#define STXH415_CKGB_REFCLK_SEL		STM_U32_REG(STXH415_CKGB_REGS_BASE + 0xb8)
...
#define STXH415_LPM_STXP70_IMEM_BASE		STM_U32_REG(STXH415_LPM_STXP70_BASE + 0x00018000)
#define STXH415_LPM_STXP70_DMEM_BASE		STM_U32_REG(STXH415_LPM_STXP70_BASE + 0x00010000)
#define STXH415_LPM_STXP70_DMEM_04		STM_U32_REG((unsigned int)(STXH415_LPM_STXP70_DMEM_BASE) + 0x04)
#define STXH415_LPM_STXP70_CONFIG_REGS_BASE	STM_U32_REG(STXH415_LPM_STXP70_BASE + 0x000b5100)
...
#endif /* __INCLUDE_STM_STXH415REG_H */
